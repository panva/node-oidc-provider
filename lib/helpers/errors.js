...
export class OIDCProviderError extends Error {
  ...
  constructor(status, message, options = undefined) {
    ...
    if (detail === undefined && options?.cause instanceof Error) {
      // TODO(v10): Stop duplicating cause.message in error_detail.
...
export class CustomOIDCProviderError extends OIDCProviderError {
  constructor(message, description, options = undefined) {
...
export class InvalidToken extends OIDCProviderError {
  ...
  constructor(options) {
    super(401, 'invalid_token', options);
    Error.captureStackTrace(this, this.constructor);
    Object.assign(this, { error_detail: this.error_detail });
  }
}
...
export class InvalidClientMetadata extends OIDCProviderError {
  constructor(description, options) {
    ...
    super(400, message, options);
    Error.captureStackTrace(this, this.constructor);
    Object.assign(this, { error_description: description, error_detail: this.error_detail });
  }
}

export class InvalidScope extends OIDCProviderError {
  constructor(description, scope, options) {
    super(400, 'invalid_scope', options);
    Error.captureStackTrace(this, this.constructor);
    Object.assign(this, { scope, error_description: description, error_detail: this.error_detail });
  }
}

export class InsufficientScope extends OIDCProviderError {
  constructor(description, scope, options) {
    super(403, 'insufficient_scope', options);
    Error.captureStackTrace(this, this.constructor);
    Object.assign(this, { scope, error_description: description, error_detail: this.error_detail });
  }
}
...
export class InvalidRequest extends OIDCProviderError {
  constructor(description, code, options) {
    super(code ?? 400, 'invalid_request', options);
    Error.captureStackTrace(this, this.constructor);
    Object.assign(this, { error_description: description || 'request is invalid', error_detail: this.error_detail, expose: true });
  }
}
...
export class InvalidClientAuth extends OIDCProviderError {
  ...
  constructor(options) {
    super(401, 'invalid_client', options);
    Error.captureStackTrace(this, this.constructor);
    Object.assign(this, { error_detail: this.error_detail });
  }
}
...
export class InvalidGrant extends OIDCProviderError {
  ...
  constructor(options) {
    super(400, 'invalid_grant', options);
    Error.captureStackTrace(this, this.constructor);
    Object.assign(this, { error_detail: this.error_detail });
  }
}
...
export class InvalidRedirectUri extends OIDCProviderError {
  ...
  constructor(options = undefined) {
    super(400, 'invalid_redirect_uri', typeof options === 'object' ? options : undefined);
    Error.captureStackTrace(this, this.constructor);
  }
}
...
export const InvalidCredentialRequest = E('invalid_credential_request');
export const InvalidNonce = E('invalid_nonce');
...
export const InvalidProof = E('invalid_proof');
...
export const UnknownCredentialConfiguration = E('unknown_credential_configuration');
export const UnknownCredentialIdentifier = E('unknown_credential_identifier');
...
export const CredentialRequestDenied = E('credential_request_denied');
...
export const UseFreshAttestation = E('use_fresh_attestation');
