...
const DEFAULTS = {
  ...
  features: {
    ...
    mTLS: {
       ...
       *
       * description: Helper used by the OP to retrieve the PEM-formatted client certificate used
       *   in the request.
       *
       ...
       *
       * description: Helper used by the OP to determine if the client certificate, used in the
