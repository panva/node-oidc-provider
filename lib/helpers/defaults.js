...
const DEFAULTS = {
   ...
   * clientCacheDuration
   *
   * description: a {Number} value (in seconds) describing how long a dynamically loaded should
   *    remain cached
...
<body>
  ...
  async interactionCheck(ctx) {
    ...
    } else if (ctx.oidc.client.applicationType === 'native' && ctx._matchedRouteName !== 'resume') {
      return {
