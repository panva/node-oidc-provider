...
function makeDefaults() {
  const defaults = {
    ...
    features: {
       ...
       *
       * description: Enables Core `CIBA` Flow, when combined with `features.fapi` and `features.requestObjects.enabled` enables [Financial-grade API: Client Initiated Backchannel Authentication Profile - Implementers Draft 01](https://openid.net/specs/openid-financial-api-ciba-ID1.html) as well.
       *
       */
      ciba: {
        enabled: false,
       ...
       *
       * description: Enables the method `attest_jwt_client_auth` for use in the server's `clientAuthMethods` configuration.
       *
       */
      attestClientAuth: {
        ack: undefined,
         ...
         *
         * description: A secret value used for generating server-provided Client Attestation PoP JWT challenges.
         * Must be a 32-byte length Buffer instance.
         */
         ...
         *
         * description: Helper function used to verify the issuer identifier of a Client Attestation JWT and to retrieve a public key
         * with which the Client Attestation JWT signature will be verified.
         *
         ...
         *
         * description: Helper function used to assert the Attestation JWT and Attestation JWT PoP beyond
         * its specification definition, e.g. according to used extension profiles.
         *
         * At the point of this helper's invocation the Attestation JWT and Attestation JWT PoP have had
         * their signatures and validity claims verified.
         */
     ...
     *
     * description: Helper function used to validate the JWT Client Authentication (`private_key_jwt`
     * and `client_secret_jwt`) Assertion Claims Set and Header beyond what its specification mandates.
     */
    assertJwtClientAuthClaimsAndHeader,
