...
function extraClientMetadataValidator(key, value, metadata, ctx) { // eslint-disable-line no-unused-vars
...
function getDefaults() {
  const defaults = {
     ...
     *   `{ ['scope']: ['claim', 'another-claim'] }`) as well as to expose additional claims that
