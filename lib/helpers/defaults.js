...
const DEFAULTS = {
  ...
  features: {
     ...
     * features.mTLS
     *
     * title: [draft-ietf-oauth-mtls-15](https://tools.ietf.org/html/draft-ietf-oauth-mtls-15) - OAuth 2.0 Mutual TLS Client Authentication and Certificate Bound Access Tokens
     *
    ...
    mTLS: {
       ...
       *
       * description: Helper used by the OP to retrieve the PEM-formatted client certificate
       *
      ...
      getCertificate(ctx) { // eslint-disable-line no-unused-vars
        ...
        throw new Error('features.mTLS.getCertificate helper not configured');
      },

      /*
       * features.mTLS.certificateAuthorized
       *
       * description: Helper used by the OP to determine if the client certificate is verified and
       *   comes from a trusted CA for the client. Should return true/false. Only used for
       *   `tls_client_auth` client authentication method.
       *
       * example: When behind a TLS terminating proxy (nginx/apache)
       *
      ...
      certificateAuthorized(ctx) { // eslint-disable-line no-unused-vars
        ...
        throw new Error('features.mTLS.certificateAuthorized helper not configured');
      },

      /*
       * features.mTLS.certificateSubjectMatches
       *
       * description: Helper used by the OP to determine if the client certificate subject matches
       *   the registered client property. Only used for `tls_client_auth` client authentication
       *   method.
       *
       * example: When behind a TLS terminating proxy (nginx/apache)
       *
      ...
      certificateSubjectMatches(ctx, property, expected) { // eslint-disable-line no-unused-vars
        ...
        throw new Error('features.mTLS.certificateSubjectMatches helper not configured');
      },
    },
     ...
     *
     * title: [draft-ietf-oauth-jwt-introspection-response-05](https://tools.ietf.org/html/draft-ietf-oauth-jwt-introspection-response-05) - JWT Response for OAuth Token Introspection
     *
     ...
     *
     * title: [draft-ietf-oauth-resource-indicators-05](https://tools.ietf.org/html/draft-ietf-oauth-resource-indicators-05) - Resource Indicators for OAuth 2.0
     *
    ...
    resourceIndicators: {
       ...
       *
       * description: Helper used by the provider to check if a request parameter should be
       ...
       *   and use that to implement your policy using this helper.
       */
     ...
     * features.request
     *
     * title: [Core 1.0](https://openid.net/specs/openid-connect-core-1_0.html#RequestObject) and [JWT Secured Authorization Request (JAR)](https://tools.ietf.org/html/draft-ietf-oauth-jwsreq-19) - Passing a Request Object by Value
     *
     ...
     * features.requestUri
     *
     * title: [Core 1.0](https://openid.net/specs/openid-connect-core-1_0.html#RequestUriParameter) and [JWT Secured Authorization Request (JAR)](https://tools.ietf.org/html/draft-ietf-oauth-jwsreq-19) - Passing a Request Object by Reference
     *
   ...
   *
   * description: helper function used by the OP to get additional access token claims
   ...
   *   and `paseto` formatted tokens as top level claims as well. Returned claims may not
