...
function getDefaults() {
  const defaults = {
    ...
    features: {
       ...
       * features.dPoP
       *
       * title: [draft-ietf-oauth-dpop-02](https://tools.ietf.org/html/draft-ietf-oauth-dpop-02) - OAuth 2.0 Demonstration of Proof-of-Possession at the Application Layer (DPoP)
       *
