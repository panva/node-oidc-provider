...
const pushInlineSha = require('./script_src_sha');
...
function getDefaults() {
  const defaults = {
     ...
     *   formatted tokens as top level claims as well. Returned claims may not
     *   overwrite pre-existing top level claims.
     *
     ...
     *     Access Token signing algorithm. Tokens using this format are not stored using the adapter,
