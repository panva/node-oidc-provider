...
function makeDefaults() {
  const defaults = {
    ...
    features: {
       ...
       *
       * title: [`OIDC Relying Party Metadata Choices 1.0 - draft 01`](https://openid.net/specs/openid-connect-rp-metadata-choices-1_0-01.html)
       *
       ...
       * - introspection_signing_alg_values_supported[^rpMetadataChoices-extras]
       * - introspection_encryption_alg_values_supported[^rpMetadataChoices-extras]
       * - introspection_encryption_enc_values_supported[^rpMetadataChoices-extras]
       * - authorization_signing_alg_values_supported[^rpMetadataChoices-extras]
       * - authorization_encryption_alg_values_supported[^rpMetadataChoices-extras]
       * - authorization_encryption_enc_values_supported[^rpMetadataChoices-extras]
       * - backchannel_authentication_request_signing_alg_values_supported[^rpMetadataChoices-extras]
       *
       * [^rpMetadataChoices-extras]: Not introduced by [`OIDC Relying Party Metadata Choices 1.0 - draft 01`](https://openid.net/specs/openid-connect-rp-metadata-choices-1_0-01.html) but still enabled following the same convention
       */
