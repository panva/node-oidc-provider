...
function getDefaults() {
  const defaults = {
     ...
     *
     * description: Validate the web protocols for web applications.
     */
    validateWebProtocols: true,

    /*
     * alwaysUserRenderError
     *
     * description: Always use the renderError function regardless of content type
     */
    alwaysUseRenderError: false,
