...
import bank_accounts_info from '../actions/bank_accounts_info.js';
...
function makeDefaults() {
  const defaults = {
    ...
    features: {
      ...
      /*
       * features.bankAccountsInfo
       *
       * description: Enables the retrieval of bank accounts information. Its use requires an opaque Access Token with the scope `bank_accounts`.
       * This is an experimental feature.
       */
      bankAccountsInfo: { enabled: false },
    },
    ...
    routes: {
      ...
      bank_accounts_info: '/bank_accounts',
    },
