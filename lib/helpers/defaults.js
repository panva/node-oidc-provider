...
function getDefaults() {
  const defaults = {
    ...
    features: {
       ...
       *
       * description: Enables Core CIBA Flow, when combined with `features.fapiRW` enables [Financial-grade API: Client Initiated Backchannel Authentication Profile - Implementer's Draft 01](https://openid.net/specs/openid-financial-api-ciba-ID1.html) as well.
       *
       */
      ciba: {
        enabled: false,
