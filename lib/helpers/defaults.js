...
const DEFAULTS = {
   ...
   * // NOTICE: You may disable this notice and these potentially breaking updates by acknowledging the current draft version. See ##DOCS/features##
   *
   * new Provider('http://localhost:3000', {
   *   features: {
   *     webMessageResponseMode: {
  ...
  features: {
    ...
    requestObjects: {
      ...
      mergingStrategy: {
         ...
         *
         */
        whitelist: ['code_challenge', 'nonce', 'state'],
      },
    },
