...
function getDefaults() {
  const defaults = {
    ...
    features: {
       ...
       * features.dPoP
       *
       * title: [draft-ietf-oauth-dpop-02](https://tools.ietf.org/html/draft-ietf-oauth-dpop-02) - OAuth 2.0 Demonstration of Proof-of-Possession at the Application Layer
       *
       ...
       * features.mTLS
       *
       * title: [RFC8705](https://tools.ietf.org/html/rfc8705) - OAuth 2.0 Mutual TLS Client Authentication and Certificate Bound Access Tokens
       *
       ...
       * features.fapiRW
       *
       * title: [Financial-grade API - Part 2: Read and Write API Security Profile - Implementer's Draft 02](https://openid.net/specs/openid-financial-api-part-2-ID2.html)
       *
       ...
       *
       * title: [draft-ietf-oauth-par-06](https://tools.ietf.org/html/draft-ietf-oauth-par-06) - OAuth 2.0 Pushed Authorization Requests
       *
      ...
      resourceIndicators: {
         ...
         *   when none is provided by the client during the call or when multiple are provided/resolved
         *   and only a single one is required.
         */
        defaultResource,
       ...
       *
       * title: [Core 1.0](https://openid.net/specs/openid-connect-core-1_0.html#RequestObject) and [JWT Secured Authorization Request (JAR)](https://tools.ietf.org/html/draft-ietf-oauth-jwsreq-30) - Request Object
       *
     ...
     * extraTokenClaims
     *
     * description: Function used to get additional claims for an Access Token
     *   when it is being issued. These claims will be available in your storage under
     *   property `extra`, returned by introspection as top level claims and pushed into
     *  `jwt` or `paseto` formatted tokens as top level claims as well. Returned claims
     *   may not overwrite pre-existing top level claims.
     *
     ...
     *   is stored using the adapter or not.
     *
