  ...
  const defaults = {
    ...
    features: {
      ...
      resourceIndicators: {
         ...
         *
         * description: Function used to load information about a resource server and check if the
         ...
         *
         * example: Resource Server with two scopes, an expected audience value and an Access Token TTL.
         * ```js
         * {
     ...
     *   Resource Server scopes don't belong here, see `features.resourceIndicators`.
     */
