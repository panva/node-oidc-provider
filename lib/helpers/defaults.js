...
const DEFAULTS = {
  ...
  features: {
    ...
    mTLS: {
      ...
      getCertificate: function getCertificate(ctx) { // eslint-disable-line no-unused-vars
       ...
       */
      /* istanbul ignore next */
      certificateAuthorized: function certificateAuthorized(ctx) { // eslint-disable-line no-unused-vars
       ...
       */
      /* istanbul ignore next */
      certificateSubjectMatches: function certificateSubjectMatches(ctx, property, expected) { // eslint-disable-line no-unused-vars
     ...
     *
     * title: [draft-lodderstedt-oauth-par-00](https://tools.ietf.org/html/draft-lodderstedt-oauth-par-00) - OAuth 2.0 Pushed Authorization Requests
     *
