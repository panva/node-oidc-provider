...
function makeDefaults() {
  const defaults = {
    ...
    features: {
       ...
       *
       * title: [draft-ietf-oauth-attestation-based-client-auth-06](https://www.ietf.org/archive/id/draft-ietf-oauth-attestation-based-client-auth-07.html) - OAuth 2.0 Attestation-Based Client Authentication
       *
     ...
     * scopes
     *
     * title: Additional OAuth 2.0 Scope Values
     *
