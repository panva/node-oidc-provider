...
function makeDefaults() {
  const defaults = {
     ...
     * loadExistingGrant
     *
     * type: (ctx: KoaContextWithOIDC) => CanBePromise<Grant | undefined>
     *
     ...
     * extraParams
     *
     * type: readonly string[] | ReadonlySet<string> | {
     *   [name: string]:
     *     | null
     *     | ((
    ...
    features: {
      ...
      dPoP: {
         ...
         *
         * type: (ctx: KoaContextWithOIDC) => boolean
         *
      ...
      deviceFlow: {
         ...
         *
         * type: (ctx: KoaContextWithOIDC) => UnknownObject
         *
         ...
         *
         * type: (ctx: KoaContextWithOIDC) => CanBePromise<undefined | void>
         *
         * description: Specifies the HTML source that shall be rendered when the device flow
      ...
      registration: {
         ...
         *
         * type: (ctx: KoaContextWithOIDC) => string
         *
         ...
         *
         * type: (ctx: KoaContextWithOIDC) => CanBePromise<string>
         *
         * description: Specifies a helper function that shall be invoked to generate random
         ...
         *
         * type: boolean | ((ctx: KoaContextWithOIDC) => CanBePromise<boolean>)
         *
    ...
    formats: {
       ...
       *
       * type: number | ((ctx: KoaContextWithOIDC, model: BaseModel) => number)
       *
    ...
    pkce: {
       ...
       * pkce.required
       *
       * type: (ctx: KoaContextWithOIDC, client: Client) => boolean
       *
     ...
     * revokeGrantPolicy
     *
     * type: (ctx: KoaContextWithOIDC) => CanBePromise<boolean>
     *
    ...
    interactions: {
       ...
       * interactions.policy
       *
       * type: readonly interactionPolicy.Prompt[]
       *
