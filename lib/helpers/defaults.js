...
async function ignoreOfflineAccessScope(ctx, client, prompts) {
  return !prompts.has('consent');
}
...
function getDefaults() {
  const defaults = {
    ...
    /*
     * ignoreOfflineAccessScope
     *
     * description: Function used to decide whether the offline_access scope is ignored when the
     *   prompt parameter is something other than consent
     *
     * example: To never ignore offline_access regardless of prompt parameter
     *
     * ```js
     * async ignoreOfflineAccessScope(ctx, client, prompts) {
     *   return false;
     * }
     * ```
     */
