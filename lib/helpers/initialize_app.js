...
const getInteraction = require('../actions/interaction.js');
const cors = require('../shared/cors.js');
const grants = require('../actions/grants/index.js');
const responseModes = require('../response_modes/index.js');
const error = require('../shared/error_handler.js');
const getAuthError = require('../shared/authorization_error_handler.js');
const contextEnsureOidc = require('../shared/context_ensure_oidc.js');

const docs = require('./docs.js');
const { InvalidRequest } = require('./errors.js');
const instance = require('./weak_cache.js');
const attention = require('./attention.js');
const { ROUTER_URL_METHOD } = require('./symbols.js');
