...
export default function initializeApp() {
  ...
  Object.entries(grants).forEach(([grantType, { handler, parameters }]) => {
    ...
    if (configuration.grantTypes.has(grantType) && !grantTypeHandlers.has(grantType)) {
      ...
      if (configuration.features.richAuthorizationRequests.enabled) {
  ...
  Koa.prototype.use.call(this, router.routes());
  ...
  Object.defineProperty(this, 'use', {
    value(fn) {
      ...
      const newMw = this.middleware.pop();
      this.middleware.splice(this.middleware.length - 1, 0, newMw);
      return this;
    },
  });
}
