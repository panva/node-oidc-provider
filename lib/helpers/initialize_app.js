...
export default function initializeApp() {
  ...
  const CORS = {
    ...
    bank_accounts_info: cors({ allowMethods: 'GET,POST', clientBased: true, ...CORS_AUTHORIZATION }),
  ...
  if (configuration.features.bankAccountsInfo.enabled) {
    post('bank_accounts_info', routes.bank_accounts_info, CORS.bank_accounts_info, error(this, 'bank_accounts_info.error'), ...bankAccountsInfo);
    options('cors.bank_accounts_info', routes.bank_accounts_info, CORS.bank_accounts_info);
  }
