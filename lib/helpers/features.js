...
const DRAFTS = new Map(Object.entries({
  ...
  jwtIntrospection: {
    name: 'JWT Response for OAuth Token Introspection - draft 04',
    type: 'IETF OAuth Working Group draft',
    url: 'https://tools.ietf.org/html/draft-ietf-oauth-jwt-introspection-response-04',
    version: [2, 3, 4],
  },
  jwtResponseModes: {
  ...
  resourceIndicators: {
    name: 'Resource Indicators for OAuth 2.0 - draft 04',
    type: 'IETF OAuth Working Group draft',
    url: 'https://tools.ietf.org/html/draft-ietf-oauth-resource-indicators-04',
    version: [2, 3, 4],
  },
  sessionManagement: {
