...
const DRAFTS = new Map(Object.entries({
  ...
  jwtIntrospection: {
    name: 'JWT Response for OAuth Token Introspection - draft 05',
    type: 'IETF OAuth Working Group draft',
    url: 'https://tools.ietf.org/html/draft-ietf-oauth-jwt-introspection-response-05',
    version: [2, 3, 4, 5],
  },
  jwtResponseModes: {
  ...
  resourceIndicators: {
    ...
    type: 'IETF OAuth Working Group draft',
    url: 'https://tools.ietf.org/html/draft-ietf-oauth-resource-indicators-05',
    version: [2, 3, 4, 5],
  },
  sessionManagement: {
