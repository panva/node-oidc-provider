...
module.exports = class Configuration {
  constructor(config) {
    ...
    _.mergeWith(this, _.pick(config, Object.keys(defaults)), (objValue, srcValue) => {
      if (Array.isArray(objValue) || objValue instanceof Set) {
        return srcValue;
      }
  ...
  defaultSigAlg() {
    ...
    this.idTokenEncryptionEncValues = this.features.encryption.enabled
    ...
    this.userinfoEncryptionEncValues = this.features.encryption.enabled
    ...
    this.introspectionEncryptionEncValues = this.features.encryption.enabled
    ...
    this.authorizationEncryptionEncValues = this.features.encryption.enabled
