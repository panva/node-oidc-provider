...
class Configuration {
  ...
  defaultSigAlg() {
    ...
    this.setAlgs('idTokenSigningAlgValues', without(allowList.idTokenSigningAlgValues, filterHSandNone));
    ...
    this.setAlgs('userinfoSigningAlgValues', without(allowList.userinfoSigningAlgValues, filterHSandNone), 'jwtUserinfo.enabled');
    ...
    this.setAlgs('introspectionSigningAlgValues', without(allowList.introspectionSigningAlgValues, filterHSandNone), 'jwtIntrospection.enabled');
    ...
    this.setAlgs('authorizationSigningAlgValues', without(allowList.authorizationSigningAlgValues, filterHS), 'jwtResponseModes.enabled');
