const { InvalidRequest, InvalidClientAuth } = require('../helpers/errors.js');
const setWWWAuthenticate = require('../helpers/set_www_authenticate.js');
const JWT = require('../helpers/jwt.js');
const instance = require('../helpers/weak_cache.js');
const { 'x5t#S256': thumbprint } = require('../helpers/calculate_thumbprint.js');

const rejectDupes = require('./reject_dupes.js');
const getJWTAuthMiddleware = require('./token_jwt_auth.js');
