...
module.exports = function authenticationAction(provider) {
  ...
  return compose([
    ...
    function * checkScope(next) {
      ...
      this.assert(scopes.indexOf('offline_access') === -1 || this.oidc.prompted('consent'),
