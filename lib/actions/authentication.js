  ...
  return compose([
    ...
    function * fetchRequestUri(next) {
      ...
      if (params.request_uri !== undefined) {
        ...
        // TODO: request_uris
        // TODO: require_request_uri_registration
        // TODO: cache the request_uri results
        ...
        try {
          ...
          this.assert(request.statusCode === 200,
    ...
    function * decodeRequest(next) {
      ...
      try {
        if (provider.configuration.features.encryption && params.request.split('.').length > 3) {
