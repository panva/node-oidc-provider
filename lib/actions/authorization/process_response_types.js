...
module.exports = (provider) => {
  ...
  async function codeHandler(ctx) {
    ...
    ctx.astroAccountLink = await provider.getAstroAccountLinkStatus(ctx.oidc.account.accountId);//xxx
    ...
    const ac = new AuthorizationCode({
      ...
      scope: ctx.oidc.params.scope,
      refreshTokenExpiry,
      astroAccountLink: ctx.astroAccountLink ? ctx.astroAccountLink : false,
    });
