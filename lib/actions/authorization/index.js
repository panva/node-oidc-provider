...
module.exports = function authorizationAction(provider, endpoint) {
  ...
  use(() => paramsMiddleware.bind(undefined, allowList),    A, DA,            PAR);
  ...
  use(() => checkResource,                                  A, DA, R, CV, DR, PAR);
  use(() => checkScope.bind(undefined, allowList),          A, DA,            PAR);
  use(() => checkOpenidScope.bind(undefined, allowList),    A, DA,            PAR);
