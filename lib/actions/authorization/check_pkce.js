 ...
 */
module.exports = function checkPixy(ctx, next) {
  ...
  if (
    ...
    && (params.response_type && params.response_type.includes('code')) // checking for response_type presence disables this for device_code grant
  ) {
