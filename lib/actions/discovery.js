...
module.exports = function discovery(ctx, next) {
  ...
  ctx.body = {
    ...
    request_object_signing_alg_values_supported:
      config.features.requestObjects.request || config.features.requestObjects.requestUri
        ? config.requestObjectSigningAlgValues : undefined,
    request_parameter_supported: config.features.requestObjects.request,
    request_uri_parameter_supported: config.features.requestObjects.requestUri,
    require_request_uri_registration: config.features.requestObjects.requestUri && config.features.requestObjects.requireUriRegistration ? true : undefined,
  ...
  if (config.features.encryption.enabled) {
    ...
    if (config.features.requestObjects.request || config.features.requestObjects.requestUri) {
  ...
  if (config.features.mTLS.enabled && config.features.mTLS.certificateBoundAccessTokens) {
