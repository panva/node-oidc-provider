...
module.exports = function discoveryAction(provider) {
  ...
  return async function renderConfiguration(ctx, next) {
    ...
    ctx.body.token_introspection_endpoint = ctx.body.introspection_endpoint; // 2.0 DEPRECATED
    ctx.body.token_revocation_endpoint = ctx.body.revocation_endpoint; // 2.0 DEPRECATED
