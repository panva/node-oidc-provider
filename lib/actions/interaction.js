...
// listed rather than spread: `view` indexes this, so spreading would make every
// export of ../views/index.js reachable through it
const viewMap = { login: views.login, interaction: views.interaction };
...
export function initialize(provider) {
...
export const render = [
  ...
  async function interactionRender(ctx) {
    ...
    locals.body = viewMap[view](locals);
