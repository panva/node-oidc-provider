...
export type FindAccount<Claims = AnyObject> = (
  ctx: KoaContextWithOIDC<Claims>,
  sub: string,
  token?: AuthorizationCode | AccessToken | DeviceCode
) => CanBePromise<Account>;
export type TokenFormat = "opaque" | "jwt" | "jwt-ietf" | "paseto";

export type AccessTokenFormatFunction<Claims> = (
  ctx: KoaContextWithOIDC<Claims>,
  token: AccessToken
) => TokenFormat;
export type ClientCredentialsFormatFunction<Claims> = (
  ctx: KoaContextWithOIDC<Claims>,
  token: ClientCredentials
) => TokenFormat;

export type TTLFunction<T, Claims> = (
  ctx: KoaContextWithOIDC<Claims>,
  token: T,
  client: Client
) => number;
...
declare class InitialAccessToken extends BaseToken {
  constructor(properties?: { expiresIn?: number; policies?: string[]; [key: string]: any });
...
declare class IdToken<Claims> {
  constructor(claims: AnyObject, context?: { ctx?: KoaContextWithOIDC<Claims>; client?: Client });

  readonly ctx: KoaContextWithOIDC<Claims>;
...
declare class OIDCContext<Claims> {
  ...
  readonly entities: {
    ...
    readonly Account?: Account<Claims>;
  ...
  readonly provider: Provider<Claims>;
...
export type KoaContextWithOIDC<Claims = AnyObject> = Koa.ParameterizedContext<{
  oidc: OIDCContext<Claims>;
}>;
...
export type AccountClaims<Claims = AnyObject> = {
  sub: string;
} & Claims;

export interface Account<Claims = AnyObject> {
  accountId: string;
  claims: (
    ...
    rejected: string[]
  ) => CanBePromise<AccountClaims<Claims>>;
}

export type RotateRegistrationAccessTokenFunction<Claims> = (
  ctx: KoaContextWithOIDC<Claims>
...
export interface Configuration<Claims = AnyObject> {
  ...
  clientBasedCORS?: (ctx: KoaContextWithOIDC<Claims>, origin: string, client: Client) => boolean;
  ...
  features?: {
    ...
    registrationManagement?: {
      enabled?: boolean;
      rotateRegistrationAccessToken?: RotateRegistrationAccessTokenFunction<Claims> | boolean;
    };
    ...
    deviceFlow?: {
      ...
      mask?: string;
      deviceInfo?: (ctx: KoaContextWithOIDC<Claims>) => AnyObject;
      userCodeInputSource?: (
        ctx: KoaContextWithOIDC<Claims>,
        form: string,
        out?: ErrorOut,
      ...
      successSource?: (ctx: KoaContextWithOIDC<Claims>) => CanBePromise<void | undefined>;
    };
    ...
    sessionManagement?: {
      ...
      keepHeaders?: boolean;
      ack?: 28 | "draft-28";
      scriptNonce?: (ctx: KoaContextWithOIDC<Claims>) => string;
    };
    ...
    mTLS?: {
      ...
      getCertificate?: (ctx: KoaContextWithOIDC<Claims>) => string;
      certificateAuthorized?: (ctx: KoaContextWithOIDC<Claims>) => boolean;
  ...
  formats?: {
    AccessToken?: AccessTokenFormatFunction<Claims> | TokenFormat;
    ClientCredentials?: ClientCredentialsFormatFunction<Claims> | TokenFormat;
    jwtAccessTokenSigningAlg?: (
      ctx: KoaContextWithOIDC<Claims>,
      token: AccessToken | ClientCredentials,
      client: Client
    ) => CanBePromise<AsymmetricSigningAlgoritm>;
    customizers?: {
      jwt?: (
        ctx: KoaContextWithOIDC<Claims>,
        token: AccessToken | ClientCredentials,
  ...
  ttl?: {
    AccessToken?: TTLFunction<AccessToken, Claims> | number;
    AuthorizationCode?: TTLFunction<AuthorizationCode, Claims> | number;
    ClientCredentials?: TTLFunction<ClientCredentials, Claims> | number;
    DeviceCode?: TTLFunction<DeviceCode, Claims> | number;
    IdToken?: TTLFunction<IdToken<Claims>, Claims> | number;
    RefreshToken?: TTLFunction<RefreshToken, Claims> | number;
  ...
  postLogoutSuccessSource?: (ctx: KoaContextWithOIDC<Claims>) => CanBePromise<void | undefined>;

  rotateRefreshToken?: ((ctx: KoaContextWithOIDC<Claims>) => CanBePromise<boolean>) | boolean;

  logoutSource?: (ctx: KoaContextWithOIDC<Claims>, form: string) => CanBePromise<void | undefined>;
  ...
  interactions?: {
    policy?: interactionPolicy.Prompt<Claims>[];
    url?: (ctx: KoaContextWithOIDC<Claims>, interaction: Interaction) => CanBePromise<string>;
  };
  ...
  findAccount?: FindAccount<Claims>;
...
export type AsymmetricSigningAlgoritm =
  | "PS256"
  | "PS384"
  | "PS512"
  | "ES256"
...
export class Provider<Claims = AnyObject> extends events.EventEmitter {
  constructor(issuer: string, configuration?: Configuration<Claims>);
  ...
  registerGrantType(
    name: string,
    handler: (ctx: KoaContextWithOIDC<Claims>, next: () => Promise<void>) => CanBePromise<void>,
  ...
  addListener(
    ...
    listener: (ctx: KoaContextWithOIDC<Claims>) => void
  ): this;
  addListener(
  ...
  addListener(
    ...
    listener: (ctx: KoaContextWithOIDC<Claims>, err: errors.OIDCProviderError) => void
  ): this;
  addListener(
  ...
  addListener(event: "grant.success", listener: (ctx: KoaContextWithOIDC<Claims>) => void): this;
  addListener(
  ...
  addListener(
    ...
    listener: (ctx: KoaContextWithOIDC<Claims>, interaction: Interaction) => void
  ): this;
  addListener(
    event: "grant.error",
    listener: (ctx: KoaContextWithOIDC<Claims>, err: errors.OIDCProviderError) => void
  ...
  addListener(
    event: "grant.revoked",
    listener: (ctx: KoaContextWithOIDC<Claims>, grantId: string) => void
  ): this;
  addListener(
  ...
  addListener(
    ...
    listener: (ctx: KoaContextWithOIDC<Claims>, client: Client) => void
  ): this;
  addListener(
  ...
  addListener(
    event: "check_session_origin.error",
    listener: (ctx: KoaContextWithOIDC<Claims>, err: errors.OIDCProviderError) => void
  ): this;
  addListener(
  ...
  addListener(
    event: "server_error",
    listener: (ctx: KoaContextWithOIDC<Claims>, err: Error) => void
  ): this;
  ...
  on(event: "authorization.accepted", listener: (ctx: KoaContextWithOIDC<Claims>) => void): this;
  on(event: "authorization.success", listener: (ctx: KoaContextWithOIDC<Claims>) => void): this;
  on(
    event: "authorization.error",
    listener: (ctx: KoaContextWithOIDC<Claims>, err: errors.OIDCProviderError) => void
  ): this;
  on(event: "end_session.success", listener: (ctx: KoaContextWithOIDC<Claims>) => void): this;
  on(
    event: "end_session.error",
    listener: (ctx: KoaContextWithOIDC<Claims>, err: errors.OIDCProviderError) => void
  ): this;
  on(event: "grant.success", listener: (ctx: KoaContextWithOIDC<Claims>) => void): this;
  on(event: "interaction.ended", listener: (ctx: KoaContextWithOIDC<Claims>) => void): this;
  on(
    event: "interaction.started",
    listener: (ctx: KoaContextWithOIDC<Claims>, interaction: Interaction) => void
  ): this;
  ...
  on(event: "server_error", listener: (ctx: KoaContextWithOIDC<Claims>, err: Error) => void): this;
  ...
  once(event: "authorization.accepted", listener: (ctx: KoaContextWithOIDC<Claims>) => void): this;
  once(event: "authorization.success", listener: (ctx: KoaContextWithOIDC<Claims>) => void): this;
  once(
    event: "authorization.error",
    listener: (ctx: KoaContextWithOIDC<Claims>, err: errors.OIDCProviderError) => void
  ): this;
  once(event: "end_session.success", listener: (ctx: KoaContextWithOIDC<Claims>) => void): this;
  once(
    event: "end_session.error",
    listener: (ctx: KoaContextWithOIDC<Claims>, err: errors.OIDCProviderError) => void
  ): this;
  once(event: "grant.success", listener: (ctx: KoaContextWithOIDC<Claims>) => void): this;
  once(event: "interaction.ended", listener: (ctx: KoaContextWithOIDC<Claims>) => void): this;
  once(
    event: "interaction.started",
    listener: (ctx: KoaContextWithOIDC<Claims>, interaction: Interaction) => void
  ): this;
  ...
  readonly Account: { findAccount: FindAccount<Claims> };
...
declare class DefaultPolicy<Claims> extends Array<interactionPolicy.Prompt<Claims>> {
  get(name: string): interactionPolicy.Prompt<Claims>;
  remove(name: string): void;
  clear(): void;
  add(prompt: interactionPolicy.Prompt<Claims>, index?: number): void;
}
...
export namespace interactionPolicy {
  class Check<Claims> {
    constructor(
      ...
      description: string,
      error: string,
      check: (ctx: KoaContextWithOIDC<Claims>) => CanBePromise<boolean>,
      details?: (ctx: KoaContextWithOIDC<Claims>) => CanBePromise<AnyObject>
    );
    constructor(
      reason: string,
      description: string,
  ...
  class Prompt<Claims> {
    constructor(info: { name: string; requestable?: boolean }, ...checks: Check<Claims>[]);
    constructor(
    ...
    name: string;
    requestable: boolean;
    details?: (ctx: KoaContextWithOIDC<Claims>) => Promise<AnyObject>;
    checks: Check<Claims>[];
  }

  function base<Claims>(): DefaultPolicy<Claims>;
}
