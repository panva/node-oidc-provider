...
- [adapter ❗](#adapter)
- [alwaysUseRenderError](#alwaysUseRenderError)
- [clients ❗](#clients)
...
- [ttl ❗](#ttl)
- [validateWebProtocols](#validatewebprotocols)
...
### validateWebProtocols

Validate the protocols for applications of type 'web'. When true the protocols must be either 'http:' or 'https:'.

### alwaysUseRenderError

When true then always the the renderError function to handle error rendoring, even when the content type isn't html.
